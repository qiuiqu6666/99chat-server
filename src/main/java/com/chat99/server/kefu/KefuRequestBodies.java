 ...
 */
final class KefuRequestBodies {

    private KefuRequestBodies() {
    }
    ...
    private static byte[] encodeParts(String contentType, Collection<Part> parts) throws IOException {
    ...
    private static String boundaryOf(String contentType) {
        ...
        return "----KefuBoundary" + Long.toHexString(System.nanoTime());
    }
