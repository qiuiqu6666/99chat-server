...
public class MessageHistoryRateLimiter {

    private static final String KEY_PREFIX = "msg:history:rl:";

    private final StringRedisTemplate redis;
    private final MessageArchiveProperties props;

    public MessageHistoryRateLimiter(StringRedisTemplate redis, MessageArchiveProperties props) {
        this.redis = redis;
        this.props = props;
    }
    ...
    public void check(String userId) {
        ...
        if (count != null && count > props.historyRateLimitPerSecond()) {
